      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
            {panelParts.map((part) => (
              <div key={part.name} className="rounded-xl border border-border bg-card px-5 py-4">
          ...
          <p className="text-xs text-muted-foreground max-w-2xl">
            The panel reads from a separate annotations file — one file maps element IDs to their backend descriptions. The prototype markup only gets <code className="font-mono text-foreground-subtle bg-secondary px-1 py-0.5 rounded text-[11px]">data-backstage="id"</code> attributes. Everything else is declarative.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-xs text-muted-foreground mt-3 max-w-2xl">
            When in doubt, prefer <span className="font-mono text-foreground-subtle">tbd</span>. A demo full of confident-but-fake "live" endpoints falls apart the moment an engineer asks a pointed question.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {implementations.map((impl) => (
              <div key={impl.name} className="rounded-xl border border-border bg-card px-5 py-4">
                <div className="flex items-center gap-2 mb-2">
